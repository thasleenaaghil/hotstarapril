...
function Slider() {
  ...
  return (
      ...
      <div className= 'slider d-flex w-100 px-1 py-4' >
        
       
           
                  {movieList.map((item,index)=>index<=0&&(  <div><img src={Image_base_url+item.backdrop_path} className='d-flex min-w-full object-cover object-left-top mr-5 rounded-md hover:border-[4px] border-gray-400' style={{height:'460px',position:'absolute'}} />
                  
                  <div className='text-light px-16  w-100  mt-5 ' style={{position:'relative',backgroundColor:'transparent',height:'350px',width:'200vh'}} >
